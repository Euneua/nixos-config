# home/desktop/hypr/hyprland/variables.nix
...
in
{
  wayland.windowManager.hyprland.settings = {
    general = {
      ...
      # Inactive border: crust color with slight transparency
    ...
    decoration = {
      ...
      blur = {
        enabled = false;  # Disabled for performance (enabled per-layer in layer-rules.nix)
      };
    };
