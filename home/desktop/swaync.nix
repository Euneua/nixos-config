  ...
  xdg.configFile."swaync/style.css".text = ''
    * {
    ...
    .control-center {
      ...
      border: 1px solid rgba(${colors."accent-rgb"}, 0.3);
      border-radius: 12px;
      margin: 8px;
      padding: 8px;
    }
    ...
    .notification {
      ...
      border: 1px solid rgba(${colors."accent-rgb"}, 0.25);
      border-radius: 10px;
      margin: 6px;
      padding: 12px;
      color: #${r.text};
    ...
    .notification:hover {
      ...
      border-color: rgba(${colors."accent-rgb"}, 0.5);
    }
    ...
    .notification-action {
      background-color: rgba(${colors."accent-rgb"}, 0.15);
      border: 1px solid rgba(${colors."accent-rgb"}, 0.3);
      border-radius: 8px;
      color: #${r.accent};
      padding: 4px 12px;
    ...
    .notification-action:hover {
      background-color: rgba(${colors."accent-rgb"}, 0.25);
      border-color: rgba(${colors."accent-rgb"}, 0.5);
    ...
    .close-button:hover {
      background-color: rgba(${colors."error-rgb"}, 0.2);
      color: #${r.error};
    }
    ...
    .widget-dnd > switch:checked {
      background-color: rgba(${colors."accent-rgb"}, 0.4);
      border-color: rgba(${colors."accent-rgb"}, 0.6);
    }
